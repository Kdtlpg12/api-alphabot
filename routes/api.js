...
loghandler = {
    ...
    invalidKey: {
        ...
        creator: `${creator}`,
        code: 406,
        message: 'silahkan hubungin owner untuk membeli apikey tersebut'
    },
    invalidlink: {
        status: false,
        creator: `${creator}`,
...
router.get('/cewe/coli', async (req, res, next) => {
	...
	if(!apikeyInput) return res.json(loghandler.notparam)	
	if (apikeyInput != 'Alphabot')  return res.json(loghandler.invalidKey)
       fetch(encodeURI(`https://raw.githubusercontent.com/Kdtlpg12/Asupan1/main/cecan/coli.json`))
        .then(response => response.json())
        .then(data => {
        var result = data;
        var result = data[Math.floor(Math.random() * data.length)];
...
router.get('/imgedit/gay2', async(req, res, next) => {
  ...
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  let hasil = `https://ojanapi-1.supportojanxsec.repl.co/api/tembak/gay?img=${url}`
  data = await fetch(hasil).then(v => v.buffer())
         await fs.writeFileSync(__path +'/tmp/tod.png', data)
        res.sendFile(__path+'/tmp/tod.png')
})
...
router.get('/imgedit/komunis', async(req, res, next) => {
  ...
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  let hasil = `https://ojanapi-1.supportojanxsec.repl.co/api/tembak/communism?img=${url}`
  data = await fetch(hasil).then(v => v.buffer())
         await fs.writeFileSync(__path +'/tmp/tod.png', data)
        res.sendFile(__path+'/tmp/tod.png')
});
...
router.get('/imgedit/hitler', async(req, res, next) => {
  ...
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  let hasil = `https://ojanapi-1.supportojanxsec.repl.co/api/hitler?url=${url}`
  data = await fetch(hasil).then(v => v.buffer())
         await fs.writeFileSync(__path +'/tmp/tod.png', data)
        res.sendFile(__path+'/tmp/tod.png')
})
...
router.get('/imgedit/discordblue', async(req, res, next) => {
 var apikeyInput = req.query.apikey
  ...
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  let hasil = `https://ojanapi-1.supportojanxsec.repl.co/api/discordblack?url=${url}`
  data = await fetch(hasil).then(v => v.buffer())
         await fs.writeFileSync(__path +'/tmp/tod.png', data)
        res.sendFile(__path+'/tmp/tod.png')
})
...
router.get('/imgedit/discordblack', async(req, res, next) => {
 var apikeyInput = req.query.apikey
  ...
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  let hasil = `https://ojanapi-1.supportojanxsec.repl.co/api/discordblue?url=${url}`
  data = await fetch(hasil).then(v => v.buffer())
         await fs.writeFileSync(__path +'/tmp/tod.png', data)
        res.sendFile(__path+'/tmp/tod.png')
})
...
router.get('/imgedit/circle', async(req, res, next) => {
 var apikeyInput = req.query.apikey
  ...
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  let hasil = `https://ojanapi-1.supportojanxsec.repl.co/api/circle?url=${url}`
  data = await fetch(hasil).then(v => v.buffer())
         await fs.writeFileSync(__path +'/tmp/tod.png', data)
        res.sendFile(__path+'/tmp/tod.png')
})
...
router.get('/imgedit/captcha', async(req, res, next) => {
 var apikeyInput = req.query.apikey
  ...
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  let hasil = `https://ojanapi-1.supportojanxsec.repl.co/api/tembak/captcha?img=${url}`
  data = await fetch(hasil).then(v => v.buffer())
         await fs.writeFileSync(__path +'/tmp/tod.png', data)
        res.sendFile(__path+'/tmp/tod.png')
})
...
router.get('/imgedit/police', async(req, res, next) => {
  ...
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  let hasil = `https://ojanapi-1.supportojanxsec.repl.co/api/tembak/police?img=${url}`
  data = await fetch(hasil).then(v => v.buffer())
         await fs.writeFileSync(__path +'/tmp/tod.png', data)
        res.sendFile(__path+'/tmp/tod.png')
})
...
router.get('/imgedit/continued', async(req, res, next) => {
  ...
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  let hasil = `https://ojanapi-1.supportojanxsec.repl.co/api/tembak/continued?img=${url}`
  data = await fetch(hasil).then(v => v.buffer())
         await fs.writeFileSync(__path +'/tmp/tod.png', data)
        res.sendFile(__path+'/tmp/tod.png')
})
...
router.get('/imgedit/putin', async(req, res, next) => {
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  let hasil = `https://ojanapi-1.supportojanxsec.repl.co/api/putin?url=${url}`
  data = await fetch(hasil).then(v => v.buffer())
         await fs.writeFileSync(__path +'/tmp/tod.png', data)
        res.sendFile(__path+'/tmp/tod.png')
})
...
router.get('/imgedit/petimati', async(req, res, next) => {
  const url = req.query.url;
  if(!url) return res.json(loghandler.noturl)
  let hasil = `https://ojanapi-1.supportojanxsec.repl.co/api/petimati?url=${url}`
  data = await fetch(hasil).then(v => v.buffer())
         await fs.writeFileSync(__path +'/tmp/tod.png', data)
        res.sendFile(__path+'/tmp/tod.png')
})
...
router.get('/imgedit/presentasi', async(req, res, next) => {
  ...
  if(!text) return res.json({ status : false, creator : `${creator}`, message : "masukan parameter text"})
  let hasil = `https://ojanapi-1.supportojanxsec.repl.co/api/lisapresentation?text=${text}`
  data = await fetch(hasil).then(v => v.buffer())
         await fs.writeFileSync(__path +'/tmp/tod.png', data)
        res.sendFile(__path+'/tmp/tod.png')
})
...
router.get('/imgedit/penjara', async(req, res, next) => {
  ...
  if(!url) return res.json(loghandler.noturl)
  let hasil = `https://ojanapi-1.supportojanxsec.repl.co/api/jail?url=${url}`
  data = await fetch(hasil).then(v => v.buffer())
         await fs.writeFileSync(__path +'/tmp/tod.png', data)
        res.sendFile(__path+'/tmp/tod.png')
})
